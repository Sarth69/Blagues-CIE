...
var affiche_nb_likes = () => {
  ...
  fetch("https://blagues-project-back.louisbout.repl.co/nb_likes?id="+id_blague).then((response) => response.json()).then((data) => {
    console.log(data);
...
var add_like = () => {
  ...
  fetch("https://blagues-project-back.louisbout.repl.co/like?id="+id_blague);
  affiche_nb_likes();
};
